    ...
    <>
      ...
      <div className="full">
        <div className="lefty">
          ...
          <div className="pc">Your Posted Cattle</div>
          <div className="auc">Your Auction</div>
        ...
        <div className="righty">
          <div className="Boxes">
            <div className="New">
              <a href="" className="New1" onClick={() => handleclick()}>
                Add New Cattle
              </a>
            </div>
            ...
            <div className="auction">
              <span className="auc1">
                ...
                <h5>Total Auction :</h5>
                <h4>11</h4>
                <h5>Recent Auction: </h5>
                <h4>5</h4>{" "}
              </span>
              <span className="auc2">
                <h5>Auction Ended:</h5> <h4>6</h4>
                <h5>Total Sales: </h5>
                <h4>105k</h4>
              </span>
            </div>
          ...
          <div className="live">
            <div className="liveAuction">
              ...
              <span className="Time">Time Remaining: 00:00:00</span>
            </div>
            <div className="liveAuctionBox">
              {cattles.map((cattle, index) => (
                <HorizontalD
                  key={cattle.id}
                  cattle={cattle}
                  cattle_image={cattle_image[index]}
                />
              ))}
            </div>
          </div>
