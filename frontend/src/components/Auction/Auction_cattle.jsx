...
const Auction_cattle = () => {
  ...
  return (
    <div className="auction_cattle">
      <h1 className="create">Create New Auction</h1>
      <br />
      <div className="btns">
        <a href="" className="Cancel">
          Cancel
        </a>
        <button onClick={handleButtonClick} className="Confirm">
          Confirm
        </button>
      </div>
      ...
      <div>
        <form action="" id="form" ref={formRef} method="post">
          <div className="name">
            {" "}
            <label htmlFor="auction_name" className="aaa">
              Auction name:
            </label>
            <input
              type="text"
          ...
          <label htmlFor="sdate" className="aaa">
            Starting Date:
          </label>
          <input
            type="date"
          ...
          />
          <label htmlFor="stime" className="aaa">
            Time:{" "}
          </label>
          <input
            type="time"
          ...
          />
          <label htmlFor="edate" className="aaa">
            Ending Date:
          </label>
          <input
            type="date"
          ...
          />
          <label htmlFor="etime" className="aaa">
            Time:{" "}
          </label>
          <input
            type="time"
